...
<head>
  ...
  <title>Fullstack Open 2020 - Toni Sánchez</title>
  <link href="https://fonts.googleapis.com/css?family=Lato:400,400i|Roboto:500" rel="stylesheet">
  <link rel="stylesheet" href="__ignore__/dist/css/style.css">
...
<body class="is-boxed has-animations">
            ...
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Fullstack Open 2020</h1>
                        <p class="hero-paragraph is-revealing">Repository of my submissions for the University of Helsinki 9 ECTS course.</p>
                        ...
                        <div class="hero-browser">
                            ...
                            <div class="hero-browser-inner is-revealing">
                                ...
                                <a href="https://studies.cs.helsinki.fi/stats/api/certificate/fullstackopen/en/8370cd299efefdfb7b5c419b06ff9595" target="_blank">
            ...
            <section class="features section text-center">
                <div class="container">
                    <div class="features-inner section-inner has-bottom-divider">
                      <h3 class="hero-title h2-mobile mt-0 is-revealing">Project app developed:</h3>
                      <p class="text-sm">Building... Soon finished.</p>
                      <br><br>

                      <h3 class="hero-title h2-mobile mt-0 is-revealing">Mandatory apps developed:</h3>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <i class="far fa-comments" style="font-size:2em; color: rgb(201, 159, 255)"></i>
                                    <h3 class="feature-title">Anecdotes</h3>
                                    <p class="text-sm">CRUD app developed with React and Node using ExpressJS.<br><span class="hastags">#mongoDB #heroku</span></p>
                                </div>
                            </div>
                            <a href="https://github.com/TonySapa/fullstackopen/tree/master/data-for-countries" target="_blank">
                              <div class="feature is-revealing">
                                  <div class="feature-inner">
                                      <!--<div class="feature-icon">
                                          <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <i class="fas fa-globe-americas" style="color:rgb(122, 187, 247); font-size:2em;"></i>
                                      <h3 class="feature-title">Countries API</h3>
                                      <p class="text-sm">RESTful API developed with React.<br><span class="hastags" style="color:rgb(122, 187, 247)">#axios #heroku</span></p>
                                  </div>
                              </div>
                            </a>
                        </div>
                        <div class="features-wrap">
                            <a href="https://github.com/TonySapa/fullstackopen/tree/master/phonebook_backend" target="_bland">
                              <div class="feature is-revealing">
                                  <div class="feature-inner">
                                      <!--<div class="feature-icon">
                                          <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <i class="far fa-address-book" style="font-size:2em;color:rgb(255, 164, 207)"></i>
                                      <h3 class="feature-title">Phonebook</h3>
                                      <p class="text-sm">CRUD app developed with React and Node using ExpressJS.<br>
                                        <span class="hastags" style="color:rgb(255, 164, 207)">#mongoDB #heroku</span>
                                      </p>
                                  </div>
                                </div>
                            </a>
                            <a href="https://github.com/TonySapa/fullstackopen/tree/master/bloglist" target="_blank">
                              <div class="feature is-revealing">
                                  <div class="feature-inner">
                                      <!--<div class="feature-icon">
                                          <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <i class="far fa-list-alt" style="font-size:2em; color:rgb(134, 255, 229)"></i>
                                      <h3 class="feature-title">Bloglist</h3>
                                      <p class="text-sm">CRUD App with TOKEN authentication developed with React and Node using ExpressJS. Deployed with Heroku.
                                        <span class="hastags" style="color:rgb(104, 211, 188)">#mongoDB #heroku</span>
                                      </p>
                                  </div>
                              </div>
                            </a>
        ...
        <footer class="site-footer text-light">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <a href="https://www.tonisanchez.dev" target="_blank">
                      <div class="footer-copyright">@tonisanchezdev</div>
                    </a>
                </div>
            </div>
        </footer>
    ...
    <script src="__ignore__/dist/js/main.min.js"></script>
</body>
</html>
